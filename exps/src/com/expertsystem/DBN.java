...
/**
 * Servlet implementation class DBN
 */
@WebServlet("/DBN")
public class DBN extends HttpServlet {
	...
	if(res.equals("atomic"))
	 ...
	 out.println("<html><body><p><center>"
	 		+ "<h1><b>RESULT</b></h1><br><br><hr>"+s+""
	 		+ "<hr><h2>Thank you for Participating!"
